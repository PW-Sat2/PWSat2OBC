...
If you are using Eclipse you can use [CppStyle](https://github.com/wangzw/CppStyle) plugin to automatically format the code using the clang-format utility and above configuration file. 
