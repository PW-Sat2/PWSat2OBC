...
// I2C
#define MAIN_BUS_I2C I2C1
#define MAIN_BUS_I2C_PORT gpioPortC
#define MAIN_BUS_I2C_SDA_PIN 4
#define MAIN_BUS_I2C_SCL_PIN 5
#define MAIN_BUS_I2C_LOCATION I2C_ROUTE_LOCATION_LOC0
