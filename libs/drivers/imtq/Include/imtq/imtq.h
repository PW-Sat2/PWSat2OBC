    ...
    namespace imtq
    {
        ...
        class ImtqDriver final : public IImtqDriver
        {
          public:
             ...
             * @return Operation status.
             */
            virtual bool ResetParameterAndGetDefault(Parameter id, gsl::span<std::uint8_t> result) override;
          ...
          private:
            ...
            template <typename Result> bool GetHouseKeeping(OpCode opcode, Result& result);
        };
    }
}
