      ...
      public:
        ...
        class Parameters final
        {
          public:
             ...
             */
            std::array<float, 3 * 3> inertia = {{0.015456f,
                0.000007f,
                0.000024f, //
                0.000007f,
                0.014745f,
             ...
             * @default {{64.70, -0.03,  -0.24},
             ...
             {-0.24,  0.31, 154.35}}
             */
            std::array<float, 3 * 3> inertiaInv = {{64.70f,
                -0.03f,
                -0.24f, //
                -0.03f,
                67.82f,
            ...
            {
                float k, kp, kn;
            } ctrlGains = {0.004f, 0.004f, 0.0001f};
             ...
             */
            std::array<float, 3> spinComm = {{5.0f * M_PI / 180.0f, 0.0f, 0.0f}};
             ...
             * @default {{0,        0,       -1},
             ...
             {0.90631, -0.42262,  0}}
             */
            std::array<float, 3 * 3> rotSS = {{0.0f,
                0.0f,
                -1.0f, //
                0.42262f,
                0.90631f,
            ...
            struct
            {
                 ...
                 */
                std::array<float, 5> Q = {{1.0f * 1e-8f, 1.0f * 1e-8f, 10.0f * 1e-8f, 10.0f * 1e-8f, 10.0f * 1e-8f}};
                 ...
                 * 180) ^ 2 }
                 */
                std::array<float, 5> R = {{powf(0.5f * M_PI / 180.0f, 2.0f),
                    powf(0.5f * M_PI / 180.0f, 2.0f),
                    powf(0.3f * M_PI / 180.0f, 2.0f),
                    powf(0.3f * M_PI / 180.0f, 2.0f),
                    powf(0.3f * M_PI / 180.0f, 2.0f)}};
                 ...
                 * M_PI / 180) ^ 2 }
                 */
                std::array<float, 5> P0 = {{powf(3.0f * 0.5f * M_PI / 180.0f, 2.0f),
                    powf(3.0f * 0.5f * M_PI / 180.0f, 2.0f),
                    powf(0.3f * M_PI / 180.0f, 2.0f),
                    powf(0.3f * M_PI / 180.0f, 2.0f),
                    powf(0.3f * M_PI / 180.0f, 2.0f)}};
            } kalmanCov;
        ...
        class State final
        {
          public:
            ...
            /** Constructor initialising parameter pool 
             * @param p Parameters to copy 
             */
         ...
         *
         * @param[out] dipole values to be commanded to dipoles [1e-4 Am2]
