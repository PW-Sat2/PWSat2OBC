...
class System final : public PureStatic
{
  public:
     ...
     * @brief Creates binary semaphore.
     *
     * @param[in] semaphoreBuffer Buffer for semaphore.
     */
    static OSSemaphoreHandle CreateBinarySemaphore(OSSemaphoreBuffer& semaphoreBuffer);
...
struct ReaderWriterLock final : private NotCopyable, private NotMoveable
{
  ...
  private:
    OSSemaphoreBuffer resourceSemaphoreBuffer;
    OSSemaphoreBuffer readCountSemaphoreBuffer;
    OSSemaphoreBuffer serviceSemaphoreBuffer;
