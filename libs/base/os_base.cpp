...
ReaderWriterLock::ReaderWriterLock()
    : resourceSemaphore(System::CreateBinarySemaphore(resourceSemaphoreBuffer)),   //
      readCountSemaphore(System::CreateBinarySemaphore(readCountSemaphoreBuffer)), //
      serviceSemaphore(System::CreateBinarySemaphore(serviceSemaphoreBuffer)),     //
      readCount(0),                                                                //
