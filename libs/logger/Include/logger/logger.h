...
#define LogMessage(withinIsr, messageLevel, message)
#define LogMessageF(withinIsr, messageLevel, message, ...)
 ...
 * @remark Do not use this macro from within interrupt service routines.
 */
#define LOGF(level, message, ...) LogMessageF(false, level, message, __VA_ARGS__)
 ...
 * @remark This macro is intended for use only from within interrupt service routines.
 */
#define LOGF_ISR(level, message, ...) LogMessageF(true, level, message, __VA_ARGS__)
 ...
 * @param[in] message Message that should be logged.
 */
#define LOGFI(withinIsr, level, message, ...) LogMessageF(withinIsr, level, message, __VA_ARGS__)
