/***************************************************************************/ /**
                                                                               ...
                                                                               *******************************************************************************
                                                                               * @section License
                                                                               * <b>Copyright 2016 Silicon Laboratories, Inc.
                                                                               *http://www.silabs.com</b>
                                                                               *******************************************************************************
                                                                               *
                                                                               ...
                                                                               *source distribution.
                                                                               *
                                                                               * DISCLAIMER OF WARRANTY/LIMITATION OF REMEDIES: Silicon Labs
                                                                               *has no obligation to support this Software. Silicon Labs is
                                                                               *providing the Software "AS IS", with no express or implied
                                                                               ...
                                                                               *incidental, or special damages, or any other relief, or for
                                                                               *any claim by any third party, arising from your use of this
                                                                               *Software.
                                                                               *
                                                                               ******************************************************************************/
...
/***************************************************************************/ /**
                                                                               ...
                                                                               * @brief Energy Management Unit (EMU) Peripheral API
                                                                               * @details
                                                                               *  This module contains functions to control the EMU
                                                                               *peripheral of Silicon Labs 32-bit MCUs and SoCs. The EMU
                                                                               *handles the different low energy modes in Silicon Labs
                                                                               *microcontrollers.
                                                                               * @{
                                                                               ******************************************************************************/
...
/***************************************************************************/ /**
                                                                               * @brief
                                                                               *   Restore oscillators and core clock after having been in
                                                                               *EM2 or EM3.
                                                                               ******************************************************************************/
...
#else
    switch (cmuStatus &
        (CMU_STATUS_HFRCOSEL | CMU_STATUS_HFXOSEL | CMU_STATUS_LFRCOSEL
...
static void dcdcFetCntSet(bool lpModeSet)
{
    ...
    if (lpModeSet)
    {
        ...
        tmp = EMU->DCDCMISCCTRL & ~(_EMU_DCDCMISCCTRL_PFETCNT_MASK | _EMU_DCDCMISCCTRL_NFETCNT_MASK);
        tmp |= (DCDC_LP_PFET_CNT << _EMU_DCDCMISCCTRL_PFETCNT_SHIFT) | (DCDC_LP_NFET_CNT << _EMU_DCDCMISCCTRL_NFETCNT_SHIFT);
...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * @details
                                                                               *   When entering EM2, the high frequency clocks are
                                                                               *disabled, ie HFXO, HFRCO and AUXHFRCO (for AUXHFRCO, see
                                                                               *exception note below). When re-entering EM0, HFRCO is
                                                                               *re-enabled and the core will be clocked by the configured
                                                                               *   HFRCO band. This ensures a quick wakeup from EM2.
                                                                               *
                                                                               *   However, prior to entering EM2, the core may have been
                                                                               *using another oscillator than HFRCO. The @p restore
                                                                               *parameter gives the user the option to restore all HF
                                                                               *oscillators according to state prior to entering EM2, as
                                                                               *well as the clock used to clock the core. This restore
                                                                               *procedure is handled by SW. However, since handled by SW, it
                                                                               *will not be restored before completing the interrupt
                                                                               *function(s) waking up the core!
                                                                               *
                                                                               * @note
                                                                               *   If restoring core clock to use the HFXO oscillator, which
                                                                               *has been disabled during EM2 mode, this function will stall
                                                                               *until the oscillator has stabilized. Stalling time can be
                                                                               *reduced by adding interrupt support detecting stable
                                                                               *oscillator, and an asynchronous switch to the original
                                                                               *oscillator. See CMU documentation. Such a feature is however
                                                                               *   outside the scope of the implementation in this function.
                                                                               * @par
                                                                               *   If HFXO is re-enabled by this function, and NOT used to
                                                                               *clock the core, this function will not wait for HFXO to
                                                                               *stabilize. This must be considered by the application if
                                                                               *trying to use features relying on that oscillator upon
                                                                               *return.
                                                                               * @par
                                                                               *   If a debugger is attached, the AUXHFRCO will not be
                                                                               *disabled if enabled upon entering EM2. It will thus remain
                                                                               *enabled when returning to EM0 regardless of the @p restore
                                                                               *parameter.
                                                                               * @par
                                                                               *   If HFXO autostart and select is enabled by using
                                                                               *CMU_HFXOAutostartEnable(), the starting and selecting of the
                                                                               *core clocks will be identical to the user independently of
                                                                               *the value of the @p restore parameter when waking up on the
                                                                               *wakeup sources corresponding to the autostart and select
                                                                               *setting.
                                                                               *
                                                                               * @param[in] restore
                                                                               *   @li true - restore oscillators and clocks, see function
                                                                               *details.
                                                                               *   @li false - do not restore oscillators and clocks, see
                                                                               *function details.
                                                                               * @par
                                                                               *   The @p restore option should only be used if all clock
                                                                               *control is done via the CMU API.
                                                                               ******************************************************************************/
void EMU_EnterEM2(bool restore)
{
#if defined(ERRATA_FIX_EMU_E107_EN)
    bool errataFixEmuE107En;
    uint32_t nonWicIntEn[2] = {0};
#endif
    ...
    /* to using HFRCO. */
#if defined(_CMU_HFCLKSTATUS_RESETVALUE)
    else if ((cmuHfclkStatus & _CMU_HFCLKSTATUS_SELECTED_MASK) != CMU_HFCLKSTATUS_SELECTED_HFRCO)
#else
...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * @details
                                                                               *   When entering EM3, the high frequency clocks are disabled
                                                                               *by HW, ie HFXO, HFRCO and AUXHFRCO (for AUXHFRCO, see
                                                                               *exception note below). In addition, the low frequency
                                                                               *clocks, ie LFXO and LFRCO are disabled by SW. When
                                                                               *   re-entering EM0, HFRCO is re-enabled and the core will be
                                                                               *clocked by the configured HFRCO band. This ensures a quick
                                                                               *wakeup from EM3.
                                                                               *
                                                                               *   However, prior to entering EM3, the core may have been
                                                                               *using another oscillator than HFRCO. The @p restore
                                                                               *parameter gives the user the option to restore all HF/LF
                                                                               *oscillators according to state prior to entering EM3, as
                                                                               *well as the clock used to clock the core. This restore
                                                                               *procedure is handled by SW. However, since handled by SW, it
                                                                               *will not be restored before completing the interrupt
                                                                               *function(s) waking up the core!
                                                                               *
                                                                               * @note
                                                                               *   If restoring core clock to use an oscillator other than
                                                                               *HFRCO, this function will stall until the oscillator has
                                                                               *stabilized. Stalling time can be reduced by adding interrupt
                                                                               *support detecting stable oscillator, and an asynchronous
                                                                               *switch to the original oscillator. See CMU documentation.
                                                                               *Such a feature is however outside the scope of the
                                                                               *   implementation in this function.
                                                                               * @par
                                                                               *   If HFXO/LFXO/LFRCO are re-enabled by this function, and
                                                                               *NOT used to clock the core, this function will not wait for
                                                                               *those oscillators to stabilize. This must be considered by
                                                                               *the application if trying to use features relying on those
                                                                               *oscillators upon return.
                                                                               * @par
                                                                               *   If a debugger is attached, the AUXHFRCO will not be
                                                                               *disabled if enabled upon entering EM3. It will thus remain
                                                                               *enabled when returning to EM0 regardless of the @p restore
                                                                               *parameter.
                                                                               *
                                                                               * @param[in] restore
...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * @note
                                                                               *   Only a power on reset or external reset pin can wake the
                                                                               *device from EM4.
                                                                               ******************************************************************************/
void EMU_EnterEM4(void)
{
    ...
    uint32_t em4seq2 = (EMU->EM4CTRL & ~_EMU_EM4CTRL_EM4ENTRY_MASK) | (2 << _EMU_EM4CTRL_EM4ENTRY_SHIFT);
    uint32_t em4seq3 = (EMU->EM4CTRL & ~_EMU_EM4CTRL_EM4ENTRY_MASK) | (3 << _EMU_EM4CTRL_EM4ENTRY_SHIFT);
#else
    uint32_t em4seq2 = (EMU->CTRL & ~_EMU_CTRL_EM4CTRL_MASK) | (2 << _EMU_CTRL_EM4CTRL_SHIFT);
    uint32_t em4seq3 = (EMU->CTRL & ~_EMU_CTRL_EM4CTRL_MASK) | (3 << _EMU_CTRL_EM4CTRL_SHIFT);
#endif
...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * @param[in] blocks
                                                                               *   Specifies a logical OR of bits indicating memory blocks
                                                                               *to power down. Bit 0 selects block 1, bit 1 selects block 2,
                                                                               *etc. Memory block 0 cannot be disabled. Please refer to the
                                                                               *reference manual for available memory blocks for a device.
                                                                               *
                                                                               * @note
                                                                               *   Only a reset can make the specified memory block(s)
                                                                               *available for use after having been powered down. Function
                                                                               *will be void for devices not supporting this feature.
                                                                               ******************************************************************************/
void EMU_MemPwrDown(uint32_t blocks)
{
#if defined(_EMU_MEMCTRL_POWERDOWN_MASK)
    EFM_ASSERT(blocks <= (_EMU_MEMCTRL_POWERDOWN_MASK >> _EMU_MEMCTRL_POWERDOWN_SHIFT));
    EMU->MEMCTRL = blocks;

#elif defined(_EMU_MEMCTRL_RAMPOWERDOWN_MASK) && defined(_EMU_MEMCTRL_RAMHPOWERDOWN_MASK) && defined(_EMU_MEMCTRL_SEQRAMPOWERDOWN_MASK)
    EFM_ASSERT((blocks & (_EMU_MEMCTRL_RAMPOWERDOWN_MASK | _EMU_MEMCTRL_RAMHPOWERDOWN_MASK | _EMU_MEMCTRL_SEQRAMPOWERDOWN_MASK)) == blocks);
    EMU->MEMCTRL = blocks;
...
/***************************************************************************/ /**
                                                                               * @brief
                                                                               *   Update EMU module with CMU oscillator selection/enable
                                                                               *status.
                                                                               *
                                                                               * @details
                                                                               *   When entering EM2 and EM3, the HW may change the core
                                                                               *clock oscillator used, as well as disabling some
                                                                               *oscillators. The user may optionally select to restore the
                                                                               *oscillators after waking up from EM2 and EM3 through the SW
                                                                               *API.
                                                                               *
                                                                               *   However, in order to support this in a safe way, the EMU
                                                                               *module must be kept up-to-date on the actual selected
                                                                               *configuration. The CMU module must keep the EMU module
                                                                               *up-to-date.
                                                                               *
                                                                               *   This function is mainly intended for internal use by the
                                                                               *CMU module, but if the applications changes oscillator
                                                                               *configurations without using the CMU API, this function can
                                                                               *be used to keep the EMU module up-to-date.
                                                                               ******************************************************************************/
...
void EMU_EM23Init(EMU_EM23Init_TypeDef* em23Init)
{
    ...
    EMU->CTRL = em23Init->em23VregFullEn ? (EMU->CTRL | EMU_CTRL_EMVREG) : (EMU->CTRL & ~EMU_CTRL_EMVREG);
#elif defined(_EMU_CTRL_EM23VREG_MASK)
    EMU->CTRL = em23Init->em23VregFullEn ? (EMU->CTRL | EMU_CTRL_EM23VREG) : (EMU->CTRL & ~EMU_CTRL_EM23VREG);
#else
        (void)em23Init;
#endif
}
...
void EMU_EM4Init(EMU_EM4Init_TypeDef* em4Init)
{
    ...
    em4conf &= ~(_EMU_EM4CONF_LOCKCONF_MASK | _EMU_EM4CONF_OSC_MASK | _EMU_EM4CONF_BURTCWU_MASK | _EMU_EM4CONF_VREGEN_MASK);

    /* Configure new settings */
    em4conf |= (em4Init->lockConfig << _EMU_EM4CONF_LOCKCONF_SHIFT) | (em4Init->osc) |
        (em4Init->buRtcWakeup << _EMU_EM4CONF_BURTCWU_SHIFT) | (em4Init->vreg << _EMU_EM4CONF_VREGEN_SHIFT);
    ...
    em4ctrl &= ~(_EMU_EM4CTRL_RETAINLFXO_MASK | _EMU_EM4CTRL_RETAINLFRCO_MASK | _EMU_EM4CTRL_RETAINULFRCO_MASK |
        _EMU_EM4CTRL_EM4STATE_MASK | _EMU_EM4CTRL_EM4IORETMODE_MASK);

    em4ctrl |= (em4Init->retainLfxo ? EMU_EM4CTRL_RETAINLFXO : 0) | (em4Init->retainLfrco ? EMU_EM4CTRL_RETAINLFRCO : 0) |
        (em4Init->retainUlfrco ? EMU_EM4CTRL_RETAINULFRCO : 0) | (em4Init->em4State ? EMU_EM4CTRL_EM4STATE_EM4H : 0) |
...
void EMU_BUPDInit(EMU_BUPDInit_TypeDef* bupdInit)
{
    ...
    reg =
        EMU->PWRCONF & ~(_EMU_PWRCONF_PWRRES_MASK | _EMU_PWRCONF_VOUTSTRONG_MASK | _EMU_PWRCONF_VOUTMED_MASK | _EMU_PWRCONF_VOUTWEAK_MASK);

    reg |= bupdInit->resistor | (bupdInit->voutStrong << _EMU_PWRCONF_VOUTSTRONG_SHIFT) |
        (bupdInit->voutMed << _EMU_PWRCONF_VOUTMED_SHIFT) | (bupdInit->voutWeak << _EMU_PWRCONF_VOUTWEAK_SHIFT);
    ...
    reg = EMU->BUCTRL & ~(_EMU_BUCTRL_PROBE_MASK | _EMU_BUCTRL_BODCAL_MASK | _EMU_BUCTRL_STATEN_MASK | _EMU_BUCTRL_EN_MASK);

    /* Note use of ->enable to both enable BUPD, use BU_VIN pin input and
       release reset */
    reg |= bupdInit->probe | (bupdInit->bodCal << _EMU_BUCTRL_BODCAL_SHIFT) | (bupdInit->statusPinEnable << _EMU_BUCTRL_STATEN_SHIFT) |
...
/***************************************************************************/ /**
                                                                               * @brief
                                                                               *   Load DCDC calibration constants from DI page. Const means
                                                                               *calibration data that does not change depending on other
...
/***************************************************************************/ /**
                                                                               * @brief
                                                                               *   Set recommended and validated current optimization and
                                                                               *timing settings
                                                                               *
                                                                               ******************************************************************************/
...
#define EMU_DCDCSMCTRL (*(volatile uint32_t*)(EMU_BASE + 0x44))
    ...
    EMU->DCDCMISCCTRL |= EMU_DCDCMISCCTRL_LPCMPHYSDIS | EMU_DCDCMISCCTRL_LPCMPHYSHI;

    family = SYSTEM_GetFamily();
    SYSTEM_ChipRevisionGet(&rev);
    if ((((family >= systemPartFamilyMighty1P) && (family <= systemPartFamilyFlex1V)) || (family == systemPartFamilyEfm32Pearl1B) ||
            (family == systemPartFamilyEfm32Jade1B)) &&
        ((rev.major == 1) && (rev.minor < 3)) && (errataFixDcdcHsState == errataFixDcdcHsInit))
    {
        /* LPCMPWAITDIS = 1 */
        EMU_DCDCSMCTRL |= 1;

        dcdcTiming = EMU->DCDCTIMING;
        dcdcTiming &= ~(_EMU_DCDCTIMING_LPINITWAIT_MASK | _EMU_DCDCTIMING_LNWAIT_MASK | _EMU_DCDCTIMING_BYPWAIT_MASK);

        dcdcTiming |=
            ((180 << _EMU_DCDCTIMING_LPINITWAIT_SHIFT) | (12 << _EMU_DCDCTIMING_LNWAIT_SHIFT) | (180 << _EMU_DCDCTIMING_BYPWAIT_SHIFT));
...
static void currentLimitersUpdate(void)
{
    ...
    const uint32_t lpcLim = (((14 + 40) + ((14 + 40) / 2)) / (5 * (DCDC_LP_PFET_CNT + 1))) - 1;
    const uint32_t lpcLimSel = lpcLim << _EMU_DCDCMISCCTRL_LPCLIMILIMSEL_SHIFT;

    /* Get enabled PFETs */
    pFetCnt = (EMU->DCDCMISCCTRL & _EMU_DCDCMISCCTRL_PFETCNT_MASK) >> _EMU_DCDCMISCCTRL_PFETCNT_SHIFT;
    ...
    lncLimSel = (((dcdcMaxCurrent_mA + 40) + ((dcdcMaxCurrent_mA + 40) / 2)) / (5 * (pFetCnt + 1))) - 1;

    /* Saturate the register field value */
    lncLimSel = SL_MIN(lncLimSel, _EMU_DCDCMISCCTRL_LNCLIMILIMSEL_MASK >> _EMU_DCDCMISCCTRL_LNCLIMILIMSEL_SHIFT);
    ...
    EMU->DCDCMISCCTRL =
        (EMU->DCDCMISCCTRL & ~(_EMU_DCDCMISCCTRL_LNCLIMILIMSEL_MASK | _EMU_DCDCMISCCTRL_LPCLIMILIMSEL_MASK)) | (lncLimSel | lpcLimSel);
    ...
    if (dcdcReverseCurrentControl >= 0)
    {
        ...
        zdetLimSel = (((maxReverseCurrent_mA + 40) + ((maxReverseCurrent_mA + 40) / 2)) / ((2 * (pFetCnt + 1)) + ((pFetCnt + 1) / 2)));
        /* Saturate the register field value */
        zdetLimSel = SL_MIN(zdetLimSel, _EMU_DCDCZDETCTRL_ZDETILIMSEL_MASK >> _EMU_DCDCZDETCTRL_ZDETILIMSEL_SHIFT);
        ...
        EMU->DCDCZDETCTRL = (EMU->DCDCZDETCTRL & ~_EMU_DCDCZDETCTRL_ZDETILIMSEL_MASK) | zdetLimSel;
    }
}

/***************************************************************************/ /**
                                                                               * @brief
                                                                               *   Set static variables that hold the user set maximum peak
                                                                               *current and reverse current. Update limiters.
                                                                               *
                                                                               * @param[in] maxCurrent_mA
                                                                               *   Set the maximum peak current that the DCDC can draw from
                                                                               *the power source.
                                                                               * @param[in] reverseCurrentControl
                                                                               *   Reverse current control as defined by
                                                                               *   @ref EMU_DcdcLnReverseCurrentControl_TypeDef. Positive
                                                                               *values have unit mA.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /**
                                                                               * @brief
                                                                               *   Load EMU_DCDCLPCTRL_LPCMPHYSSEL depending on LP bias, LP
                                                                               *feedback attenuation and DEVINFOREV.
                                                                               *
                                                                               * @param[in] attSet
...
static bool LpCmpHystCalibrationLoad(bool lpAttenuation, uint32_t lpCmpBias)
{
    ...
    if (devinfoRev < 4)
    {
        ...
        {
            lpcmpHystSel =
                (lpcmpHystSel & _DEVINFO_DCDCLPCMPHYSSEL0_LPCMPHYSSELLPATT1_MASK) >> _DEVINFO_DCDCLPCMPHYSSEL0_LPCMPHYSSELLPATT1_SHIFT;
        }
        else
        {
            lpcmpHystSel =
                (lpcmpHystSel & _DEVINFO_DCDCLPCMPHYSSEL0_LPCMPHYSSELLPATT0_MASK) >> _DEVINFO_DCDCLPCMPHYSSEL0_LPCMPHYSSELLPATT0_SHIFT;
        }
    }
    /* devinfoRev >= 4
...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * @note
                                                                               * If the power circuit is configured for NODCDC as described
                                                                               *in Section 11.3.4.3 of the Reference Manual, do not call
                                                                               *this function. Instead call EMU_DCDCPowerOff().
                                                                               *
                                                                               * @param[in] dcdcInit
...
bool EMU_DCDCInit(EMU_DCDCInit_TypeDef* dcdcInit)
{
    ...
    EMU->DCDCMISCCTRL = (EMU->DCDCMISCCTRL & ~(_EMU_DCDCMISCCTRL_LPCMPBIAS_MASK | _EMU_DCDCMISCCTRL_LNFORCECCM_MASK)) |
        ((uint32_t)lpCmpBiasSel | (dcdcInit->reverseCurrentControl >= 0 ? EMU_DCDCMISCCTRL_LNFORCECCM : 0));
    ...
    userCurrentLimitsSet(dcdcInit->maxCurrent_mA, dcdcInit->reverseCurrentControl);
...
bool EMU_DCDCOutputVoltageSet(uint32_t mV, bool setLpVoltage, bool setLnVoltage)
{
    ...
    {
        validOutVoltage = ((mV >= PWRCFG_DCDCTODVDD_VMIN) && (mV <= PWRCFG_DCDCTODVDD_VMAX));
    }
    ...
    {
        if (((lnMode == 0) && !setLpVoltage) || ((lnMode == 1) && !setLnVoltage))
        {
            continue;
        }

        ctrlReg = (lnMode ? &EMU->DCDCLNVCTRL : &EMU->DCDCLPVCTRL);
        vrefShift = (lnMode ? _EMU_DCDCLNVCTRL_LNVREF_SHIFT : _EMU_DCDCLPVCTRL_LPVREF_SHIFT);
        ...
        if (lnMode)
        {
            ...
            if (attSet)
            {
                ...
                vrefHigh = (vrefLow & _DEVINFO_DCDCLNVCTRL0_3V0LNATT1_MASK) >> _DEVINFO_DCDCLNVCTRL0_3V0LNATT1_SHIFT;
                vrefLow = (vrefLow & _DEVINFO_DCDCLNVCTRL0_1V8LNATT1_MASK) >> _DEVINFO_DCDCLNVCTRL0_1V8LNATT1_SHIFT;
            }
            else
            {
                vrefLow = DEVINFO->DCDCLNVCTRL0;
                vrefHigh = (vrefLow & _DEVINFO_DCDCLNVCTRL0_1V8LNATT0_MASK) >> _DEVINFO_DCDCLNVCTRL0_1V8LNATT0_SHIFT;
                vrefLow = (vrefLow & _DEVINFO_DCDCLNVCTRL0_1V2LNATT0_MASK) >> _DEVINFO_DCDCLNVCTRL0_1V2LNATT0_SHIFT;
            }
        }
        else
        {
            ...
            switch (attMask | lpcmpBias)
            {
                case EMU_DCDCLPVCTRL_LPATT | EMU_DCDCMISCCTRL_LPCMPBIAS_BIAS0:
                    ...
                    vrefHigh =
                        (vrefLow & _DEVINFO_DCDCLPVCTRL2_3V0LPATT1LPCMPBIAS0_MASK) >> _DEVINFO_DCDCLPVCTRL2_3V0LPATT1LPCMPBIAS0_SHIFT;
                    vrefLow = (vrefLow & _DEVINFO_DCDCLPVCTRL2_1V8LPATT1LPCMPBIAS0_MASK) >> _DEVINFO_DCDCLPVCTRL2_1V8LPATT1LPCMPBIAS0_SHIFT;
                    break;

                case EMU_DCDCLPVCTRL_LPATT | EMU_DCDCMISCCTRL_LPCMPBIAS_BIAS1:
                    vrefLow = DEVINFO->DCDCLPVCTRL2;
                    vrefHigh =
                        (vrefLow & _DEVINFO_DCDCLPVCTRL2_3V0LPATT1LPCMPBIAS1_MASK) >> _DEVINFO_DCDCLPVCTRL2_3V0LPATT1LPCMPBIAS1_SHIFT;
                    vrefLow = (vrefLow & _DEVINFO_DCDCLPVCTRL2_1V8LPATT1LPCMPBIAS1_MASK) >> _DEVINFO_DCDCLPVCTRL2_1V8LPATT1LPCMPBIAS1_SHIFT;
                    break;

                case EMU_DCDCLPVCTRL_LPATT | EMU_DCDCMISCCTRL_LPCMPBIAS_BIAS2:
                    vrefLow = DEVINFO->DCDCLPVCTRL3;
                    vrefHigh =
                        (vrefLow & _DEVINFO_DCDCLPVCTRL3_3V0LPATT1LPCMPBIAS2_MASK) >> _DEVINFO_DCDCLPVCTRL3_3V0LPATT1LPCMPBIAS2_SHIFT;
                    vrefLow = (vrefLow & _DEVINFO_DCDCLPVCTRL3_1V8LPATT1LPCMPBIAS2_MASK) >> _DEVINFO_DCDCLPVCTRL3_1V8LPATT1LPCMPBIAS2_SHIFT;
                    break;

                case EMU_DCDCLPVCTRL_LPATT | EMU_DCDCMISCCTRL_LPCMPBIAS_BIAS3:
                    vrefLow = DEVINFO->DCDCLPVCTRL3;
                    vrefHigh =
                        (vrefLow & _DEVINFO_DCDCLPVCTRL3_3V0LPATT1LPCMPBIAS3_MASK) >> _DEVINFO_DCDCLPVCTRL3_3V0LPATT1LPCMPBIAS3_SHIFT;
                    vrefLow = (vrefLow & _DEVINFO_DCDCLPVCTRL3_1V8LPATT1LPCMPBIAS3_MASK) >> _DEVINFO_DCDCLPVCTRL3_1V8LPATT1LPCMPBIAS3_SHIFT;
                    break;

                case EMU_DCDCMISCCTRL_LPCMPBIAS_BIAS0:
                    vrefLow = DEVINFO->DCDCLPVCTRL0;
                    vrefHigh =
                        (vrefLow & _DEVINFO_DCDCLPVCTRL0_1V8LPATT0LPCMPBIAS0_MASK) >> _DEVINFO_DCDCLPVCTRL0_1V8LPATT0LPCMPBIAS0_SHIFT;
                    vrefLow = (vrefLow & _DEVINFO_DCDCLPVCTRL0_1V2LPATT0LPCMPBIAS0_MASK) >> _DEVINFO_DCDCLPVCTRL0_1V2LPATT0LPCMPBIAS0_SHIFT;
                    break;

                case EMU_DCDCMISCCTRL_LPCMPBIAS_BIAS1:
                    vrefLow = DEVINFO->DCDCLPVCTRL0;
                    vrefHigh =
                        (vrefLow & _DEVINFO_DCDCLPVCTRL0_1V8LPATT0LPCMPBIAS1_MASK) >> _DEVINFO_DCDCLPVCTRL0_1V8LPATT0LPCMPBIAS1_SHIFT;
                    vrefLow = (vrefLow & _DEVINFO_DCDCLPVCTRL0_1V2LPATT0LPCMPBIAS1_MASK) >> _DEVINFO_DCDCLPVCTRL0_1V2LPATT0LPCMPBIAS1_SHIFT;
                    break;

                case EMU_DCDCMISCCTRL_LPCMPBIAS_BIAS2:
                    vrefLow = DEVINFO->DCDCLPVCTRL1;
                    vrefHigh =
                        (vrefLow & _DEVINFO_DCDCLPVCTRL1_1V8LPATT0LPCMPBIAS2_MASK) >> _DEVINFO_DCDCLPVCTRL1_1V8LPATT0LPCMPBIAS2_SHIFT;
                ...
                case EMU_DCDCMISCCTRL_LPCMPBIAS_BIAS3:
                    vrefLow = DEVINFO->DCDCLPVCTRL1;
                    vrefHigh =
                        (vrefLow & _DEVINFO_DCDCLPVCTRL1_1V8LPATT0LPCMPBIAS3_MASK) >> _DEVINFO_DCDCLPVCTRL1_1V8LPATT0LPCMPBIAS3_SHIFT;
                    vrefLow = (vrefLow & _DEVINFO_DCDCLPVCTRL1_1V2LPATT0LPCMPBIAS3_MASK) >> _DEVINFO_DCDCLPVCTRL1_1V2LPATT0LPCMPBIAS3_SHIFT;
                    break;
...
/***************************************************************************/ /**
                                                                               * @brief
                                                                               *   Optimize DCDC slice count based on the estimated average
                                                                               *load current in EM0
                                                                               *
...
void EMU_DCDCOptimizeSlice(uint32_t em0LoadCurrent_mA)
{
    ...
    uint32_t rcoBand = (EMU->DCDCLNFREQCTRL & _EMU_DCDCLNFREQCTRL_RCOBAND_MASK) >> _EMU_DCDCLNFREQCTRL_RCOBAND_SHIFT;
    ...
    sliceCount = (sliceCount << _EMU_DCDCMISCCTRL_PFETCNT_SHIFT | sliceCount << _EMU_DCDCMISCCTRL_NFETCNT_SHIFT);
    EMU->DCDCMISCCTRL = (EMU->DCDCMISCCTRL & ~(_EMU_DCDCMISCCTRL_PFETCNT_MASK | _EMU_DCDCMISCCTRL_NFETCNT_MASK)) | sliceCount;
...
void EMU_DCDCLnRcoBandSet(EMU_DcdcLnRcoBand_TypeDef band)
{
    ...
    EMU->DCDCLNFREQCTRL = (EMU->DCDCLNFREQCTRL & ~_EMU_DCDCLNFREQCTRL_RCOBAND_MASK) | (band << _EMU_DCDCLNFREQCTRL_RCOBAND_SHIFT);
}
...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * @details
                                                                               *   This function powers off the DCDC controller. This
                                                                               *function should only be used if the external power circuit
                                                                               *is wired for no DCDC. If the external power circuit is wired
                                                                               *for DCDC usage, then use EMU_DCDCInit() and set the DCDC in
                                                                               *bypass mode to disable DCDC.
                                                                               *
                                                                               * @return
...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * @details
                                                                               *   Initialize a VMON channel without hysteresis. If the
                                                                               *channel supports separate rise and fall triggers, both
                                                                               *thresholds will be set to the same value.
                                                                               *
                                                                               * @param[in] vmonInit
    ...
    switch (vmonInit->channel)
    {
        case emuVmonChannel_AVDD:
            EMU->VMONAVDDCTRL = (thresholdCoarse << _EMU_VMONAVDDCTRL_RISETHRESCOARSE_SHIFT) |
                (thresholdFine << _EMU_VMONAVDDCTRL_RISETHRESFINE_SHIFT) | (thresholdCoarse << _EMU_VMONAVDDCTRL_FALLTHRESCOARSE_SHIFT) |
                (thresholdFine << _EMU_VMONAVDDCTRL_FALLTHRESFINE_SHIFT) | (vmonInit->riseWakeup ? EMU_VMONAVDDCTRL_RISEWU : 0) |
                (vmonInit->fallWakeup ? EMU_VMONAVDDCTRL_FALLWU : 0) | (vmonInit->enable ? EMU_VMONAVDDCTRL_EN : 0);
            break;
        case emuVmonChannel_ALTAVDD:
            EMU->VMONALTAVDDCTRL = (thresholdCoarse << _EMU_VMONALTAVDDCTRL_THRESCOARSE_SHIFT) |
                (thresholdFine << _EMU_VMONALTAVDDCTRL_THRESFINE_SHIFT) | (vmonInit->riseWakeup ? EMU_VMONALTAVDDCTRL_RISEWU : 0) |
                (vmonInit->fallWakeup ? EMU_VMONALTAVDDCTRL_FALLWU : 0) | (vmonInit->enable ? EMU_VMONALTAVDDCTRL_EN : 0);
            break;
        case emuVmonChannel_DVDD:
            EMU->VMONDVDDCTRL = (thresholdCoarse << _EMU_VMONDVDDCTRL_THRESCOARSE_SHIFT) |
                (thresholdFine << _EMU_VMONDVDDCTRL_THRESFINE_SHIFT) | (vmonInit->riseWakeup ? EMU_VMONDVDDCTRL_RISEWU : 0) |
                (vmonInit->fallWakeup ? EMU_VMONDVDDCTRL_FALLWU : 0) | (vmonInit->enable ? EMU_VMONDVDDCTRL_EN : 0);
            break;
        case emuVmonChannel_IOVDD0:
            EMU->VMONIO0CTRL = (thresholdCoarse << _EMU_VMONIO0CTRL_THRESCOARSE_SHIFT) |
                (thresholdFine << _EMU_VMONIO0CTRL_THRESFINE_SHIFT) | (vmonInit->retDisable ? EMU_VMONIO0CTRL_RETDIS : 0) |
                (vmonInit->riseWakeup ? EMU_VMONIO0CTRL_RISEWU : 0) | (vmonInit->fallWakeup ? EMU_VMONIO0CTRL_FALLWU : 0) |
...
/***************************************************************************/ /**
                                                                               * @brief
                                                                               *   Initialize VMON channel with hysteresis (separate rise
                                                                               *and fall triggers).
                                                                               *
                                                                               * @details
                                                                               *   Initialize a VMON channel which supports hysteresis. The
                                                                               *AVDD channel is the only channel to support separate rise
                                                                               *and fall triggers.
                                                                               *
                                                                               * @param[in] vmonInit
    ...
    switch (vmonInit->channel)
    {
        case emuVmonChannel_AVDD:
            EMU->VMONAVDDCTRL = (riseThresholdCoarse << _EMU_VMONAVDDCTRL_RISETHRESCOARSE_SHIFT) |
                ...
                (fallThresholdFine << _EMU_VMONAVDDCTRL_FALLTHRESFINE_SHIFT) | (vmonInit->riseWakeup ? EMU_VMONAVDDCTRL_RISEWU : 0) |
                (vmonInit->fallWakeup ? EMU_VMONAVDDCTRL_FALLWU : 0) | (vmonInit->enable ? EMU_VMONAVDDCTRL_EN : 0);
            break;
        default:
            EFM_ASSERT(false);
...
/***************************************************************************/ /**
                                                                               ...
                                                                               *
                                                                               * @return
                                                                               *   Status of the selected VMON channel. True if channel is
                                                                               *triggered.
                                                                               ******************************************************************************/
