...
void yaffs_unpack_tags2_tags_only(struct yaffs_ext_tags* t, struct yaffs_packed_tags2_tags_only* ptt)
{
...
void yaffs_unpack_tags2(struct yaffs_ext_tags* t, struct yaffs_packed_tags2* pt, int tags_ecc)
{
    ...
    if (pt->t.seq_number != 0xffffffff && tags_ecc)
    {
        ...
        result = yaffs_ecc_correct_other(
            (unsigned char*)&pt->t, sizeof(struct yaffs_packed_tags2_tags_only), &pt->ecc, &ecc);
        switch (result)
        {
            case 0:
