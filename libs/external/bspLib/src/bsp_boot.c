 ...
 * @date	16/06/2013
 *
 * This function sets up the MCU with a new SP and PC. It should be used
 * when transferring execution from the bootloader to the main application.
 *
 * @deprecated
 *   This function has been deprecated. Just use
 *   \link BOOT_boot BOOT_boot\endlink instead.
 *
 * @param [in] sp
 *   Stack Pointer of application to be executed. Located at application
 *   base. Use following line of code to get stack pointer:
 *   \code sp = *((uint32_t *) bootAddress); \endcode
 * @param [in] pc
 *   Program Counter of appliation to be executed. Located at application
 *   base + 1. Use following line of code to get program counter:
 *   \code pc = *((uint32_t *) bootAddress + 1); \endcode
 *
 *****************************************************************************/
