...
namespace obc
{
    namespace telecommands
    {
        ...
        SetTimeTelecommand::SetTimeTelecommand(IHasState<SystemState>& stateContainer_, ICurrentTime& timeProvider_, IRTC& rtc_)
            : stateContainer(stateContainer_), timeProvider(timeProvider_), rtc(rtc_)
        {
        }
