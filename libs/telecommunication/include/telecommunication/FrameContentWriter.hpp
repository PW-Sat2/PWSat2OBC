    ...
    namespace downlink
    {
        ...
        class FrameContentWriter final
        {
          public:
             ...
             * and advances the current buffer position to the next unused byte.
             * @param[in] fieldId Identifier of the stored field.
             * @param[in] dword Double word that should be added to writer output using little endian byte ordering.
             * @return Operation status.
             */
          ...
          private:
            /**
             * @brief Saves field identifier to stream.
            ...
            /**
             * @brief Object responsible for writing values into byte stream.
             */
            Writer& writer;
        };
