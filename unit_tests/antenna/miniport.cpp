...
INSTANTIATE_TEST_CASE_P(AntennaDeploymentStatusTestSet,
    ...
    testing::Values(std::make_tuple(0, 0, I2CResultNack, OSResultIOError, 0u, 0u, false, false),
                            std::make_tuple(0, 0, I2CResultOK, OSResultSuccess, 0x01010101u, 0u, false, false),
                            std::make_tuple(1, 0, I2CResultOK, OSResultSuccess, 0x01010101u, 0u, false, true),
                            std::make_tuple(0, 1, I2CResultOK, OSResultSuccess, 0x01010101u, 0u, true, false),
                            std::make_tuple(2, 0, I2CResultOK, OSResultSuccess, 0x01010101u, 0x1000000, false, false),
                            std::make_tuple(8, 0, I2CResultOK, OSResultSuccess, 0x00010101u, 0u, false, false),
                            std::make_tuple(0x0a, 0, I2CResultOK, OSResultSuccess, 0x00010101u, 0x1000000, false, false),
                            std::make_tuple(0x20, 0, I2CResultOK, OSResultSuccess, 0x01010101u, 0x10000, false, false),
                            std::make_tuple(0x80, 0, I2CResultOK, OSResultSuccess, 0x01000101u, 0u, false, false),
                            std::make_tuple(0xa0, 0, I2CResultOK, OSResultSuccess, 0x01000101u, 0x10000, false, false),
                            std::make_tuple(0, 2, I2CResultOK, OSResultSuccess, 0x01010101u, 0x100, false, false),
                            std::make_tuple(0, 8, I2CResultOK, OSResultSuccess, 0x01010001u, 0u, false, false),
                            std::make_tuple(0, 0x0a, I2CResultOK, OSResultSuccess, 0x01010001u, 0x100, false, false),
                            std::make_tuple(0, 0x20, I2CResultOK, OSResultSuccess, 0x01010101u, 0x1, false, false),
                            std::make_tuple(0, 0x80, I2CResultOK, OSResultSuccess, 0x01010100u, 0u, false, false),
                            std::make_tuple(0, 0xa0, I2CResultOK, OSResultSuccess, 0x01010100u, 0x1, false, false),
                            std::make_tuple(0, 0x10, I2CResultOK, OSResultOutOfRange, 0x0, 0u, false, false)), );
