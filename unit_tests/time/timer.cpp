...
TEST_F(TimerTest, TestDefaultState)
{
    ...
    ASSERT_THAT(GetCurrentTime(), Eq(0ull));
...
TEST_F(TimerTest, TestAdvanceTimeWithNotificationLockFailure)
{
    ...
    TimeAdvanceTime(&provider, 10001);
    ASSERT_THAT(GetCurrentTime(), Eq(10001u));
}
...
TEST_F(TimerTest, TestMultipleJumps)
{
    ...
    TimeAdvanceTime(&provider, 3500);
    TimeAdvanceTime(&provider, 2000);
    ASSERT_THAT(GetCurrentTime(), Eq(6500u));
}
...
TEST_F(TimerTest, TestSetTime)
{
    ...
    ASSERT_THAT(GetCurrentTime(), Eq(446582001u));
}
...
TEST_F(TimerTest, TestSetTimeLockError)
{
    ...
    ASSERT_THAT(GetCurrentTime(), Ne(446582001u));
}
