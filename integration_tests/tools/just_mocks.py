...
Arguments may also be stored in file and passed with '@file' syntax. Arguments in file should be separated with whitespace
    ...
    parser.add_argument('--grc_uplink_ip', required=False, default='localhost', help="GRC Uplink IP")
    parser.add_argument('--grc_uplink_port', required=False, default=7002, help="GRC Uplink PORT")
    parser.add_argument('--grc_downlink_ip', required=False, default='localhost', help="GRC Downlink IP")
    parser.add_argument('--grc_downlink_port', required=False, default=7003, help="GRC Downlink PORT")
...
class JustMocks(object):
    def __init__(self, mock_com, enable_zmq, grc_uplink_ip="localhost", grc_uplink_port=7002, grc_downlink_ip="localhost", grc_downlink_port=7003):
        ...
        if enable_zmq:
            self.zmq_adapter = ZeroMQAdapter(self.comm, grc_uplink_ip=grc_uplink_ip, grc_uplink_port=grc_uplink_port, grc_downlink_ip=grc_downlink_ip, grc_downlink_port=grc_downlink_port)
...
just_mocks = JustMocks(mock_com=config.config['MOCK_COM'], enable_zmq=not args.disable_zmq,
					  grc_uplink_ip=args.grc_uplink_ip, grc_uplink_port=args.grc_uplink_port, grc_downlink_ip=args.grc_downlink_ip, grc_downlink_port=args.grc_downlink_port)
